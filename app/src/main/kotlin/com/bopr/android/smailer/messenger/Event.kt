...
data class Event(
    ...
    companion object {
        ...
        /* Bypass reason flags. Explains why an event was not processed. */

        val BYPASS_NO_MESSENGERS = bit(0)
        val BYPASS_NUMBER_BLACKLISTED = bit(1)
        val BYPASS_TEXT_BLACKLISTED = bit(2)
        val BYPASS_TRIGGER_IS_OFF = bit(3)

        /* Processing flags. Explains how exactly an event was processed. */
