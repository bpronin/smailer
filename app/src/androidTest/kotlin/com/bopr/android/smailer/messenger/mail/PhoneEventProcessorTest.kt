...
//        })
        ...
        Assert.assertEquals(STATE_PROCESSED, savedEvent.processState)
        Assert.assertEquals(PhoneEventData.ACCEPT_STATE_ACCEPTED, savedEvent.acceptState)
    ...
    fun testProcessIgnored() {
        ...
        Assert.assertEquals(STATE_IGNORED, savedEvent.processState)
        Assert.assertEquals(PhoneEventData.ACCEPT_STATE_BYPASS_TRIGGER_OFF, savedEvent.acceptState)
    }
...
//        verify(messenger, never()).login(any(), any())
        ...
        Assert.assertEquals(STATE_PENDING, savedEvent.processState)
        Assert.assertEquals(PhoneEventData.ACCEPT_STATE_ACCEPTED, savedEvent.acceptState)
    }
